...
var app = &cli.App{
	...
	Flags: []cli.Flag{
		...
		&cli.StringFlag{
			...
			EnvVars:     []string{envPrefix + "DATABASE_HOST"},
			Destination: &options.dbHost,
		},
		&cli.IntFlag{
			Name:        "db-port",
			Usage:       "The port number of the database server",
			EnvVars:     []string{envPrefix + "DATABASE_PORT"},
			Value:       5432,
